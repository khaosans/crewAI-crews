...
class AINewsLetterTasks():
    def fetch_news_task(self, agent):
        return Task(
            description=f'Fetch top AI and Blockchain news stories from the past 24 hours. The current time is {datetime.now()}.',
            agent=agent,
            async_execution=True,
            expected_output="""A list of top AI and blockchain news story titles, URLs, and a brief summary for each story from the past 24 hours. 
                Example Output: 
                [
